...
export default function ArticlesPage() {
    ...
    return (
        <>
            ...
            <div className="grid w-full max-w-5xl px-4 mx-auto gap-4">
                ...
                {loading && (
                    <div
                        className="col-span-2 flex items-center justify-center my-4 overflow-hidden"
                        role="status"
                    >
                        <svg
                            aria-hidden="true"
                ...
                <InfiniteScroll
                    className="w-full grid grid-cols-2 gap-4 sm:grid-cols-2"
                    dataLength={remainingArticles.length}
                    next={fetchMoreData}
                    hasMore={hasMore}
                    loader={
                        <>
                            <div
                                className="col-span-2 flex items-end justify-center my-4 overflow-hidden"
                                role="status"
                            >
                                <svg
                                    aria-hidden="true"
